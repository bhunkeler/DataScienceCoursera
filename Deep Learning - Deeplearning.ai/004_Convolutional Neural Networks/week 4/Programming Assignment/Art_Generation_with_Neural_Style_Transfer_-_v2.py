...
def compute_layer_style_cost(a_S, a_G):
    ...
    J_style_layer = const * tf.reduce_sum(tf.reduce_sum((GS - GG)**2))
    ### END CODE HERE ###
...
if own == True:
    ...
    content_image = scipy.misc.imread("images/Elena_950_1425.jpg")
...
if own == True:
    ...
    style_image = scipy.misc.imread("images/Elena_paint1_300_400.jpg")
