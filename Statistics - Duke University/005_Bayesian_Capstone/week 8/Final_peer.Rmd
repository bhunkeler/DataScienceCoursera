...
```{r, creategraphs,  fig.width = 8, fig.height = 8, message = FALSE}
...
```{r,  fig.width = 10, fig.height = 10, warning = FALSE, message = FALSE, include = TRUE, results = 'hide'}
...
```{r loadvalidation, message = FALSE, fig.width = 8, fig.height = 8}
df.train <- df.train.NoOutliner
