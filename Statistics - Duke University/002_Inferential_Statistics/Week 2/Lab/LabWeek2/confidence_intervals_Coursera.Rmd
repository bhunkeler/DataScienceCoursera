...
```{r set-seed}
set.seed(2100714)                 # make sure to change the seed
```
...
# Typical size means the average size of the area a house has been built on.
mean(samp$area)
...
# plot the histogram with the mean and median value
