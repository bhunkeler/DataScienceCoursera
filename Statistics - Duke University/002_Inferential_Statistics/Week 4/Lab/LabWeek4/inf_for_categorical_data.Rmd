...
ME <- 1.96 * sqrt( p_atheists * (1 - p_atheists) / dim(us12)[1])
ME
...
# spain05_12 <- atheism %>% filter(nationality == "Spain") %>% group_by(year)

# inference(y = response, data = spain05_12, statistic = "proportion", type = "ci", method = "theoretical", success = "atheist")
